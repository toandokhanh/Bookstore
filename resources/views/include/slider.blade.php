			...
			<div class="section group">
				...
				<div style="margin-left: 10px" class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						...
						<div style="margin-left: 40px; margin-bottom: 5px;" class="button"><span><a href="{{ route('detail-product',['id'=>$product->id]) }}">Thêm <span class="fix-icon-in-slider"><ion-icon style="width: 20px;" class="cart__icon" name="cart-outline"></ion-icon> </span></a></span></div>
				   </div>
			   </div>
			   @endforeach		
			</div>
