...
<div class="main">
    <div class="content">
		...
		<div class="section group sm:flex justify-center">
			<div class="grid_1_of_4 images_1_of_4 ">
				 <a href={{ route('detail') }}><img src="image_books/home/3.jpg" alt="" /></a>
			...
			<div class="grid_1_of_4 images_1_of_4">
				<a href={{ route('detail') }}><img src="image_books/home/7.jpg" alt="" /></a>
			...
			<div class="grid_1_of_4 images_1_of_4">
				<a href={{ route('detail') }}><img src="image_books/home/8.jpg" alt="" /></a>
		...
		<div class="clear"></div>
			...
			<div class="section group sm:flex justify-center">
				<div class="grid_1_of_4 images_1_of_4">
					 <a href={{ route('detail') }}><img src="./image_books/home/1.jpg" alt="" /></a>
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href={{ route('detail') }}><img src="./image_books/home/2.jpg" alt="" /></a>
				...
				<div class="grid_1_of_4 images_1_of_4">
					<a href={{ route('detail') }}><img src="./image_books/home/5.jpg" alt="" /></a>
